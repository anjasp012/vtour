...
<body class="bg-admin-bg min-h-screen flex items-center justify-center p-4 antialiased">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-[10%] -right-[10%] w-[40%] h-[40%] bg-indigo-600/20 rounded-full blur-[120px]">
        </div>
    </div>
    ...
    <div class="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div class="flex flex-col items-center mb-8">
            <div
                class="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center shadow-xl shadow-blue-500/40 mb-4 transform -rotate-6">
                <i class="fas fa-cube text-white text-2xl"></i>
            </div>
            <h1 class="text-3xl font-black text-white tracking-tighter uppercase">360<span
                    class="text-slate-500">STUDIO</span></h1>
        ...
        <div class="glass-card p-8">
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label class="block text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-2 ml-1">Email
                        Address</label>
                    <div class="relative">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        ...
                        <div
                            class="w-4 h-4 rounded border border-white/10 flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-all">
                            <i class="fas fa-check text-white text-[8px] opacity-0 peer-checked:opacity-100"></i>
                        </div>
                        <span
                            class="text-slate-400 text-[10px] font-bold uppercase tracking-widest group-hover:text-slate-300 transition-colors">Remember
                            Me</span>
                    </label>
                </div>
        ...
        <div class="mt-8 text-center">
            <a href="{{ url('/') }}"
                class="text-slate-500 hover:text-slate-300 text-[10px] font-bold uppercase tracking-widest transition-colors flex items-center justify-center gap-2">
